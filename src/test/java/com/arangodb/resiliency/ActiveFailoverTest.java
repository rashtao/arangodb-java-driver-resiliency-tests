...
public abstract class ActiveFailoverTest {
    ...
    private static final List<Endpoint> endpoints = List.of(
            new Endpoint("activeFailover1", HOST, 8529, "172.28.113.1:8529"),
            new Endpoint("activeFailover2", HOST, 8539, "172.28.113.2:8529"),
            new Endpoint("activeFailover3", HOST, 8549, "172.28.113.3:8529")
    );
